...
Creative Commons Attribution 4.0 International (CC BY 4.0) license. We
retain five numerical variables: `age`, `education_num`, `capital_gain`,
`capital_loss`, and `hours_per_week`.

The package also includes simulated Gaussian cluster datasets generated
