...
Jo Y, Kim M (2026). *dppca: Differentially Private PCA with Scree Plot
and Score Visualization*. R package version 0.1.0,
<https://github.com/yejinjo0220/dppca>.

    @Manual{,
      title = {dppca: Differentially Private PCA with Scree Plot and Score Visualization},
