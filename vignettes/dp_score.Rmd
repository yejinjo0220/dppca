...
As practical guidelines, asymptotic bin rules often scale with the sample size.
...
as in [Lei (2011)](#ref-Lei2011). Since the score histogram is two-dimensional,
we take \(d=2\). These rules should be treated as starting points rather than
fixed prescriptions.
